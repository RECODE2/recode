...
var j1 = fs.readFileSync("/home/saso/Desktop/TestVOMIDAX/C1.json");
var j2 = fs.readFileSync("/home/saso/Desktop/TestVOMIDAX/C2.json");
var j3 = fs.readFileSync("/home/saso/Desktop/TestVOMIDAX/fileEliminate.json");
...
fsPath.writeFile("C:/Users/Davide/Desktop/YAYO.json", JSON.stringify(obj3, null, "\t"), function(err){
 ...
 var obj3 = caricaImmagine(obj2,obj1);
  var obj3 = purgaJSON(obj3, obj4); 

  //var obj3 = diffJSON(obj1,obj2,obj4);

  fsPath.writeFile("/home/saso/Desktop/TestVOMIDAX/fileCompeto.json", JSON.stringify(obj3, null, "\t"), function(err){
    if(err) {
      throw err;
    } else {
      //console.log('Json fatto');
...
function diffJSON(obj1, obj2/* ,idCommit, req*/,fileEliminate2) {
    ...
    fsPath.writeFile("/home/saso/Desktop/TestVOMIDAX/file.json", JSON.stringify(fileEliminate, null, "\t"), function(err){
        if(err) {
          throw err;
        } else {
